...
type ChannelValueDialogProps = {
    ...
    features?: ChannelValueDialogFeatures;
    /**
...
interface ChannelValueDialogState {
    open: boolean;
    valueStateId: string;
    /**
 ...
 */
class ChannelValueDialog extends React.Component<ChannelValueDialogProps, ChannelValueDialogState> {
    private previewTimer: ReturnType<typeof setTimeout> | null = null;

    constructor(props: ChannelValueDialogProps) {
        super(props);
        this.state = {
            open: false,
            valueStateId: '',
     ...
     */
    public openWith(config?: Partial<ChannelValueConfig>): void {
     ...
     */
    public triggerPreviewFor(config: Partial<ChannelValueConfig>): void {
        if (this.previewTimer !== null) {
            clearTimeout(this.previewTimer);
        }
        const df = config?.dateFormat;
...
export default ChannelValueDialog;
