...
const popupTest = {
  ...
  config: {
    ...
    data: {
      ...
      setValue2: { type: "state", dp: "0_userdata.0.NSPanel.Flur.popupNotify.popupNotifyAction" }
      // mit setValue2 wird 1, bei yes und 2 bei no auf true gesetzt
    }
  },
  pageItems: [],
  items: void 0
...
const pageQRTest = {
  ...
  config: {
    ...
    data: {
      ...
      pwdHidden: { type: "const", constVal: false }
    }
  }
};
