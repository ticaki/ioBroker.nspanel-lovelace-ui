...
class PageMedia extends import_pageMenu.PageMenu {
  ...
  static async getPage(configManager, page, gridItem, messages) {
    ...
    if (!page.media.id || configManager.validStateId(page.media.id) === false) {
      const msg = configManager.validStateId(page.media.id) ? `${page.uniqueName}: Media page has no device id!` : `${page.uniqueName}: Media page id ${page.media.id} is not valid!`;
      messages.push(msg);
      adapter.log.warn(msg);
      return { gridItem, messages };
    }
    ...
    async function getPageSpotify(configManager2, page2, gridItem2, messages2) {
      var _a2, _b2, _c2, _d2, _e2, _f2, _g2, _h2;
      {
        ...
        gridItem2 = {
          ...
          config: {
            ...
            data: {
              ...
              title: {
                ...
                true: page2.media.colorMediaArtist ? {
                  color: await configManager2.getFieldAsDataItemConfig(
                    page2.media.colorMediaArtist
                  )
                } : void 0
              },
              duration: {
              ...
              onOffColor: {
                true: page2.media.colorMediaIcon ? { color: await configManager2.getIconColor(page2.media.colorMediaIcon) } : void 0
              },
              elapsed: {
                mode: "auto",
                type: "triggered",
              ...
              artist: {
                ...
                true: page2.media.colorMediaArtist ? {
                  color: await configManager2.getIconColor(page2.media.colorMediaArtist)
                } : void 0
              },
              shuffle: {
                value: {
          ...
          pageItems: [
            ...
            //speaker select
            {
              ...
              data: {
                ...
                valueList: {
                  type: "const",
                  constVal: JSON.stringify(page2.media.speakerList || [])
                },
                /**
                 * setList: {id:Datenpunkt, value: zu setzender Wert}[] bzw. stringify  oder ein String nach dem Muster datenpunkt?Wert|Datenpunkt?Wert {input_sel}
                 */
            ...
            //playlist select
            {
              ...
              data: {
                ...
                valueList: {
                  type: "const",
                  constVal: JSON.stringify(page2.media.playList || [])
                },
                headline: {
                  type: "const",
                  constVal: "playList"
          ...
          uniqueID: page2.uniqueName
        };
      }
      return { gridItem: gridItem2, messages: messages2 };
    }
    return { gridItem, messages };
  }
  async isPlaying() {
