      ...
      switch (entry.type) {
        ...
        case "fan": {
          if (entry.type === "fan") {
            ...
            message.icon = (_A = await tools.getIconEntryValue(item.icon, value, "")) != null ? _A : "";
            message.iconColor = (_B = await tools.getIconEntryColor(item.icon, value, Color.HMIOn)) != null ? _B : "";
            return tools.getPayload(
              message.type,
              message.intNameEntity,
              message.icon,
